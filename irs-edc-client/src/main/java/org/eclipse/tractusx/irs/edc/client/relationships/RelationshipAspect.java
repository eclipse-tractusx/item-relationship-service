...
public enum RelationshipAspect {
    ...
    SINGLE_LEVEL_USAGE_AS_BUILT("SingleLevelUsageAsBuilt", SingleLevelUsageAsBuilt.class, BomLifecycle.AS_BUILT,
            Direction.UPWARD),
    SINGLE_LEVEL_USAGE_AS_PLANNED("SingleLevelUsageAsPlanned", SingleLevelUsageAsPlanned.class, BomLifecycle.AS_PLANNED,
            Direction.UPWARD);
    ...
    /**
     * asBuilt + downward => SingleLevelBomAsBuilt <br>
     * asPlanned + downward => SingleLevelBomAsPlanned <br>
     * asSpecified + downward => SingleLevelBomAsSpecified <br>
     * asBuilt + upward => SingleLevelUsageAsBuilt <br>
     * asPlanned + upward => SingleLevelUsageAsPlanned
     *
