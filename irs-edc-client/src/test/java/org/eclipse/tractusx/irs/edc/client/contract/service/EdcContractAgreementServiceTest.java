...
class EdcContractAgreementServiceTest {
    ...
    void setUp() {
        ...
        edcConfiguration.getControlplane().getEndpoint().setData("https://irs-consumer-controlplane.dev.demo.catena-x.net/data");
    ...
    void shouldReturnContractAgreements() throws ContractAgreementException {
        ...
        Mockito.verify(restTemplate)
               .postForEntity(eq("https://irs-consumer-controlplane.dev.demo.catena-x.net/data/v2/contractagreements/request"), any(),
    ...
    void shouldReturnContractAgreementNegotiation() {
        ...
        //THEN
        Mockito.verify(restTemplate)
               .getForEntity("https://irs-consumer-controlplane.dev.demo.catena-x.net/data/v2/contractagreements/contractAgreementId/negotiation",
