...
class EndpointDataReferenceCacheServiceTest {
    ...
    @Test
    public void shouldReturnStatusRequiredNewWhenThereIsNoRecordInCache() {
        // given
    ...
    @Test
    public void shouldReturnStatusExpiredAndCorrectEndpointDataReferenceWhenThereIsRecordInCacheWithExpiredToken() {
        // given
        final String assetId = "assetId";
    ...
    @Test
    public void shouldReturnStatusValidAndCorrectEndpointDataReferenceWhenThereIsRecordInCacheWithValidToken() {
        // given
        final String assetId = "assetId";
