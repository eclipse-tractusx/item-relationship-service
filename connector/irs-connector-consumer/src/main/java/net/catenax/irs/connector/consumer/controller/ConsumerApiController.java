...
//
package net.catenax.irs.connector.consumer.controller;
...
import net.catenax.irs.connector.consumer.service.StatusResponse;
import net.catenax.irs.connector.parameters.GetStatusParameters;
...
public class ConsumerApiController {
     ...
     *
     * @param request Contains a PartsTreeByObjectIdRequest corresponding to irs-request and other
     *                information such that the destination file where the result of the IRS
