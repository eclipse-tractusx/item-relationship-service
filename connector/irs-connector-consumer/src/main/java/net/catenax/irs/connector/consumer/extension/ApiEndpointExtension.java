...
public class ApiEndpointExtension implements ServiceExtension {
    ...
    public void initialize(final ServiceExtensionContext context) {
        ...
        //final var dataRequestGenerator = new DataRequestFactory(monitor, configuration,
        // jsonUtil, registryClient);
        // final var logic = new JobsTreeRecursiveLogic(monitor, blobStoreApi, jsonUtil,
        // dataRequestGenerator, assembler);
        // final var jobHandler = new JobsTreeRecursiveJobHandler(monitor, configuration,
        // jsonUtil, null);
