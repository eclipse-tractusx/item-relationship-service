...
public final class StubRegistryClientFactory {
     ...
     * */
    private static final String DATASPACE_PARTITIONS = "irs.dataspace.partitions";
     ...
     */
    private static final String DATASPACE_PARTITION_DEPLOYMENTS = "irs.dataspace.partition.deployments";
