...
## [CATENA-X Release 23.12]([https://github.com/eclipse-tractusx/sig-release/issues/494](https://github.com/eclipse-tractusx/sig-release/issues/85)) [4.0.2](https://github.com/eclipse-tractusx/item-relationship-service/releases/tag/4.0.2) - 2023-11-20
| Dependency                | Version                      | Helm       | Comments        |
|---------------------------|------------------------------|------------|-----------------|
| EDC                       | 0.5.3                        | 0.5.3      |                 |
| EDC PostgresSQL           | 15.1.0-debian-11-r12         | 12.1.6     | Optional        |
