...
Feature: Policy Store
  ...
  Scenario: Register and get all policies
    ...
    When a policy with policyId "integration-test-policy-01" is registered for BPN "BPNL1234567890AB" and validUntil "1111-11-11T11:11:11.111Z"
    ...
    And a policy with policyId "integration-test-policy-02" is registered for BPN "BPNL1234567890AB" and validUntil "1111-11-11T11:11:11.111Z"
    And I add policyId "integration-test-policy-02" to given BPNs using validUntil "1111-11-11T11:11:11.111Z":
      | BPNL1234567890AB |
      | BPNL1234567890CD |
    And a policy with policyId "integration-test-policy-03" is registered for BPN "BPNL1234567890CD" and validUntil "1111-11-11T11:11:11.111Z"
    And a policy with policyId "integration-test-policy-04" is registered for BPN "BPNL1234567890CD" and validUntil "1111-11-11T11:11:11.111Z"
  ...
  Scenario: Update a policy validUntil date for a policy that is associated to multiple BPNs
    ...
    Given a policy with policyId "integration-test-policy-01" is registered for BPN "BPNL1234567890AB" and validUntil "1111-11-11T11:11:11.111Z"
    # 'POST policies' only supports one BPN, therefore if we want to associate a policy with multiple BPNs
    # we first need to create it via POST for the first BPN
    # and then add it via 'UPDATE policies' to all BPNs to which it should be associated
    # (note that this also update the validUntil).
    And a policy with policyId "integration-test-policy-02" is registered for BPN "BPNL1234567890AB" and validUntil "2222-11-11T11:11:11.111Z"
    And I add policyId "integration-test-policy-02" to given BPNs using validUntil "2223-11-11T11:11:11.111Z":
      | BPNL1234567890AB |
      | BPNL1234567890CD |
    And a policy with policyId "integration-test-policy-03" is registered for BPN "BPNL1234567890CD" and validUntil "3333-11-11T11:11:11.111Z"
    And a policy with policyId "integration-test-policy-04" is registered for BPN "BPNL1234567890CD" and validUntil "4444-11-11T11:11:11.111Z"
    And I fetch all policies
  ...
  Scenario: Delete 3 policies
    Given no policies with prefix "integration-test-policy-" exist
    Given a policy with policyId "integration-test-policy-01" is registered for BPN "BPNL1234567890AB" and validUntil "2222-11-11T11:11:11.111Z"
    And I add policyId "integration-test-policy-01" to given BPNs using validUntil "1111-11-11T11:11:11.111Z":
      | BPNL1234567890AB |
      | BPNL1234567890EF |
    And a policy with policyId "integration-test-policy-02" is registered for BPN "BPNL1234567890AB" and validUntil "1111-11-11T11:11:11.111Z"
    And I add policyId "integration-test-policy-02" to given BPNs using validUntil "1111-11-11T11:11:11.111Z":
      | BPNL1234567890AB |
      | BPNL1234567890CD |
    And   a policy with policyId "integration-test-policy-03" is registered for BPN "BPNL1234567890CD" and validUntil "2222-11-11T11:11:11.111Z"
    And   a policy with policyId "integration-test-policy-04" is registered for BPN "BPNL1234567890CD" and validUntil "2222-11-11T11:11:11.111Z"
    And I fetch all policies
