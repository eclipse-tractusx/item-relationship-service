...
import net.catenax.irs.mappers.PartRelationshipEntityListToDtoMapper;
import net.catenax.irs.repositories.PartAspectRepository;
import net.catenax.irs.repositories.PartAttributeRepository;
import net.catenax.irs.repositories.PartRelationshipRepository;
...
public class PartsTreeQueryService {
    ...
    public PartRelationshipsWithInfos getPartsTree(final PartsTreeByObjectIdRequest request) {
        ...
        if (depth > configuration.getPartsTreeMaxDepth()) {
            throw new MaxDepthTooLargeException(MessageFormat.format(ApiErrorsConstants.ITEM_MAX_DEPTH, configuration.getPartsTreeMaxDepth()));
        }
        ...
        final var typeNames = attributeRepository.findAllBy(allIds, IrsConfiguration.PART_TYPE_NAME_ATTRIBUTE);
