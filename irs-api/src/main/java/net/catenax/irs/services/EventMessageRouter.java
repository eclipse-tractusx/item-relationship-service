...
import static net.catenax.irs.configuration.MetricsConfiguration.MESSAGE_AGE;
import static net.catenax.irs.configuration.MetricsConfiguration.MESSAGE_PROCESSING_TIME;
...
@KafkaListener(topics = "${irs.kafkaTopic}")
