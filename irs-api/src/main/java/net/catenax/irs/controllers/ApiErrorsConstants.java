...
public class ApiErrorsConstants {
    ...
    public static final String ITEM_VIEW_NOT_NULL = "Must not be null, provide either AS_BUILT or AS_MAINTAINED.";
    public static final String ITEM_VIEW_MUST_MATCH_ENUM = "Must be either AS_BUILT or AS_MAINTAINED.";
