...
public class IrsController {
    ...
    public Jobs getBOMForJobId(final @Valid @Parameter(description = "ID of the job in processing.",
        ...
        min = IrsApiConstants.JOB_ID_SIZE,
        max = IrsApiConstants.JOB_ID_SIZE) UUID jobId, final @Parameter(
        description = "If true, the endpoint returns the current state of the fetched bom tree.") @Schema(
        implementation = Boolean.class, defaultValue = "true", required = false) boolean returnUncompletedResultTree) {
