...
public class PartTypeInformationEntity {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(manufacturerPartId, that.manufacturerPartId) && Objects.equals(customerPartId,
                that.customerPartId) && Objects.equals(nameAtManufacturer, that.nameAtManufacturer) && Objects.equals(
                nameAtCustomer, that.nameAtCustomer) && Objects.equals(classification, that.classification);
    }

    @Override
    public int hashCode() {
        return Objects.hash(manufacturerPartId, customerPartId, nameAtManufacturer, nameAtCustomer, classification);
    }
}
