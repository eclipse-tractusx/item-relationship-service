...
import static net.catenax.irs.systemtest.SystemTestsBase.ASPECT_MATERIAL;
...
public class ConnectorSystemTests {
    ...
    private static final String consumerURI = System.getProperty("ConnectorConsumerURI",
            "https://catenaxdev001akssrv.germanywestcentral.cloudapp.azure.com/irs-connector-consumer");
