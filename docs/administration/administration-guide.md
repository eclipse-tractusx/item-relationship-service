    ...
    grafana:
      ...
      dashboards:
        default:
          ...
          irs-outbound-requests-dashboard:
            json: |
              {
                "annotations": {
                  "list": [
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "code",
                        "expr": "sum by(le) (increase(http_client_requests_seconds_bucket{client_name=\"irs-aas-registry.dev.demo.catena-x.net\"}[$__interval]))",
                        "legendFormat": "{{le}}",
                        "range": true,
                        "refId": "A"
                      },
                      {
                        ...
                        "editorMode": "builder",
                        "exemplar": false,
                        "expr": "sum by(le) (increase(http_client_requests_seconds_bucket{client_name=\"aaswrapper\"}[$__interval]))",
                        "hide": false,
                        "legendFormat": "__auto",
                        "range": true,
                        "refId": "B"
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "builder",
                        "expr": "round(sum by(client_name) (increase(http_client_requests_seconds_count{outcome=\"SERVER_ERROR\"}[100y])), 1)",
                        "legendFormat": "{{client_name}} 5xx",
                        "range": true,
                        "refId": "A"
                      },
                      {
                        ...
                        "editorMode": "builder",
                        "expr": "round(sum by(client_name) (increase(http_client_requests_seconds_count{outcome=\"CLIENT_ERROR\"}[100y])), 1)",
                        "hide": false,
                        "legendFormat": "{{client_name}} 4xx",
                        "range": true,
                        "refId": "B"
                      }
                    ],
                    "title": "Total error responses by client",
                    "type": "timeseries"
                  },
                  {
                    "datasource": {
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "code",
                        "expr": "sum by(client_name) (rate(http_client_requests_seconds_sum[$__rate_interval]))",
                        "legendFormat": "__auto",
                        "range": true,
                        "refId": "A"
                      }
                    ],
                    "title": "Request duration by client (seconds)",
                    "type": "timeseries"
                  },
                  {
                    "datasource": {
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "builder",
                        "expr": "increase(http_requests_retries_total[100y])",
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "builder",
                        "expr": "increase(http_requests_timeouts_total[100y])",
                        "legendFormat": "{{endpoint}}",
                        "range": true,
                        "refId": "A"
                      }
                      ...
                      "overrides": [
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"system_cpu_usage\", application=\"item-relationship-service\", instance=\"app-irs-dev:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                      ...
                      "overrides": [
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"system_load_average_1m\", application=\"item-relationship-service\", instance=\"app-irs-dev:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "color",
                      ...
                      "overrides": [
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "sum(jvm_memory_used_bytes{area=\"heap\"}) / 1024"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                        ...
                        },
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "sum(jvm_memory_used_bytes{area=\"nonheap\"}) / 1024"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "code",
                        "expr": "sum(jvm_memory_used_bytes{area=\"heap\"}) / 1024",
                        "legendFormat": "__auto",
                        "range": true,
                        "refId": "A"
                      },
                      {
                        ...
                        "editorMode": "builder",
                        "expr": "sum(jvm_memory_used_bytes{area=\"nonheap\"}) / 1024",
                        "hide": false,
                        "range": true,
                        "refId": "B"
                      }
                    ],
                    "title": "Memory Usage in MByte",
                    "type": "timeseries"
                  },
                  {
                    "datasource": {
                      ...
                      "overrides": [
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"process_cpu_usage\", application=\"item-relationship-service\", instance=\"app-irs-int:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                        ...
                        },
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{instance=\"127.0.0.1:9090\", job=\"prometheus\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                              "value": "Total Process Usage Second"
                            }
                          ]
                        },
                        {
                    ...
                    "targets": [
                      {
                        ...
                        "editorMode": "code",
                        "expr": "increase(process_cpu_usage[10s])",
                        "legendFormat": "__auto",
                        "range": true,
                        "refId": "A"
                      },
                      ...
                      "overrides": [
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"jvm_threads_live_threads\", application=\"item-relationship-service\", instance=\"app-irs-dev:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                        ...
                        },
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"jvm_threads_peak_threads\", application=\"item-relationship-service\", instance=\"app-irs-dev:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                        ...
                        },
                        {
                          "matcher": {
                            "id": "byName",
                            "options": "{__name__=\"jvm_threads_daemon_threads\", application=\"item-relationship-service\", instance=\"app-irs-dev:4004\", job=\"spring-actuator\"}"
                          },
                          "properties": [
                            {
                              "id": "displayName",
                              "value": "Daemon Threads"
                            }
                          ]
                        }
                      ]
