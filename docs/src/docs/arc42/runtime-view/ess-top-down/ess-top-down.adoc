...
| [<b>[000]</b>] | IncidentManager | Request ESS Incident investigation | -

| [<b>[001]</b>] | Inquiring OEM Company | Check direct suppliers | -
|                 | Inquiring OEM Company | Check BPNS in direct suppliers | -

| [<b>[002]</b>] | Inquiring OEM Company | Forward incident to Tier N+1 Supplier | -
| [<b>[003]</b>] | Tier N+1 Supplier | Check direct suppliers | -
|                 | Tier N+1 Supplier | Check BPNS in direct suppliers | -
|                 | Tier N+1 Supplier | Forward incident to Tier N+n Supplier | -

| [<b>[004]</b>] | Tier N+n Supplier | Check direct suppliers | -
...
| [<b>[005]</b>] | Tier N+1 Supplier | Aggregate results | -
|                 | Tier N+1 Supplier | Return responses (including hops) to Inquiring OEM Company | ESS supplier response

| [<b>[006]</b>] | Inquiring OEM Company | Aggregate results | -
|                 | Inquiring OEM Company | Check subgraph infection on first tier level | -

| [<b>[007]</b>] | IncidentManager | Receive incident report from Inquiring OEM Company | -
|===
...
This ESS incident acts as the root incident for the overall process
The incident contains a company name (incl. address) and a valid BPN exists for that company. The BPN (a BPNL or BPNS) can be looked up in BPDM.

=== Step 1: Check direct suppliers

The inquiring company checks, if the company of the incident is a direct supplier of him
In orders to perform this check, the following data must be available in the inquiring company:
...
The incident is forwarded to all direct suppliers. Each direct supplier is sent a "personalized" request to evaluate, if the inquiring company is impacted by the incident.
The incident in enhanced with additional data by the inquiring company:
list of parts, that are supplied to the inquiring company by his direct supplier.
...
IRS, along with other services like DiscoveryFinder, EDCDiscoveryService, and SubmodelServer, collaborates to look up shells for the given BPN, returning an array of AAS identifiers.
...
The _Client App (Script)_ filters the AAS collection for SubmodelDescriptors marked as planned, based on certain criteria.
