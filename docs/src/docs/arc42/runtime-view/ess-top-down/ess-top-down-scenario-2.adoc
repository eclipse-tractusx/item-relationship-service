...
....
include::../../../../uml-diagrams/runtime-view/ess-(top-down)/4_ess_top_down_sequence_RegisterEssInvestigationJob.puml[]
....
...
| Retrieves the EDC endpoint for Tier1 based on the childCXId.
