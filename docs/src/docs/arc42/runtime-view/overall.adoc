...
== Job orchistration flow

This section describes the job orchistration in IRS.

[plantuml, target=job-orchistration, format=svg]
....
include::../../../uml-diagrams/runtime-view/job-orchistration-sequence.puml[]
....
