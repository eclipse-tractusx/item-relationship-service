...
State consistency, message correlation, notification validation, privacy and restart recovery apply across all recursive processing steps. They are described in xref:../../cross-cutting/recursive-irs.adoc[Recursive IRS concepts].
