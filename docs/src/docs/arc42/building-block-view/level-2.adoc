...
|REST controller for receiving recursive REQUEST and RESPONSE notifications from partner IRS instances.
...
|RecursiveNotificationContractValidator
|Reads routing fields from the raw notification JSON, strictly decodes the notification and validates the REQUEST or RESPONSE contract.
