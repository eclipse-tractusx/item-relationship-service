...
|*EssService*
|The *EssService* implements the REST Interface of the EssController and handles recursive investigation with results calculations.

|*PolicyStoreController*
|The *PolicyStoreController* provides a REST Interface for creating and retrieving policies that should be accepted in EDC negotiations.
