...
. Register the DTR, PURIS and Industry Core accepted policies described below in the IRS Policy Store through `POST /irs/policies`. A consumed contract offer must satisfy an active accepted policy.
