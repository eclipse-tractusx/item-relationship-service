...
=== OAuth2
OAuth2 protocol is used by IRS to protect the APIs and other resources. This means you can configure and use any identity and access management tool that provides OAuth 2.0 functionality.
